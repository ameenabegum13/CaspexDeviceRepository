...
public class DeviceController {
	...
	/*
	 * @GetMapping("/os/{osName}") public ResponseEntity<List<Device>>
	 * getDevicesByOsName(@PathVariable String osName) { List<Device> devices =
	 * deviceService.findByOsName(osName); return devices.isEmpty() ?
	 * ResponseEntity.notFound().build() : ResponseEntity.ok(devices); }
	 */
